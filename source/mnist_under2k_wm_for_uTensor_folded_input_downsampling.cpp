...
#include "mnist_under2k_wm_for_uTensor_folded_input_downsampling_weight.hpp"
#include "uTensor/ops/ArrayOps.hpp"
#include "uTensor/ops/MatrixOps.hpp"
#include "uTensor/core/context.hpp"
#include "uTensor/core/tensor.hpp"
#include "mnist_under2k_wm_for_uTensor_folded_input_downsampling.hpp"
...
{    
    ctx.add(new BinaryTensor<int>({1}, inline_sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_reshape_dims_0), 
            sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_reshape_dims_0, 
            1);
}
{
    ctx.add(new RamTensor<float>(), sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_reshape_0, 2);
    ctx.push(new ReshapeOp(), 
             { sref_Placeholder_0, sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_reshape_dims_0 },
             { sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_reshape_0 });
    ctx.eval();
}
{    
    ctx.add(new BinaryTensor<int>({1}, inline_sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_reduction_dims_0), 
            sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_reduction_dims_0, 
            2);
}
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_min_0, 1);
    ctx.push(new MinOp(), 
             { sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_reshape_0, sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_reduction_dims_0 },
             { sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_min_0 });
    ctx.eval();
}
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_max_0, 1);
    ctx.push(new MaxOp(), 
             { sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_reshape_0, sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_reduction_dims_0 },
             { sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_max_0 });
    ctx.eval();
}
{
    ctx.add(new RamTensor<uint8_t>(), sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_quantize_0, 1);
    ctx.add(new RamTensor<float>({1}), sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_quantize_1, 1);
    ctx.add(new RamTensor<float>({1}), sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_quantize_2, 1);
    ctx.push(new QuantizeV2Op(),
             {  sref_Placeholder_0,  sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_min_0, sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_max_0 },
             {  sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_quantize_0,  sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_quantize_1, sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_quantize_2 });
    ctx.eval();
}
{    
...
}
{
    ...
    ctx.push(new QntConvOp<uint8_t, uint8_t, int>({ 1, 1, 1, 1 }, VALID),
             { sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_quantize_0, sref_model_stochastic_conv2d__channel__pruning_weights_quant_FakeQuantWithMinMaxVars_eightbit_requantize_0, sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_quantize_1, sref_model_stochastic_conv2d__channel__pruning_Conv2D_eightbit_Placeholder__port__0_quantize_2, sref_model_stochastic_conv2d__channel__pruning_weights_quant_FakeQuantWithMinMaxVars_eightbit_requantize_1, sref_model_stochastic_conv2d__channel__pruning_weights_quant_FakeQuantWithMinMaxVars_eightbit_requantize_2 },
...
{    
    ctx.add(new BinaryTensor<int>({2}, inline_sref_model_Reshape_shape_0), 
...
}
{
    ...
    ctx.push(new QuantizedReshapeOp(),
              { sref_model_stochastic_conv2d__channel__pruning_act_quant_FakeQuantWithMinMaxVars_eightbit_0, sref_model_Reshape_shape_0, sref_model_stochastic_conv2d__channel__pruning_act_quant_FakeQuantWithMinMaxVars_eightbit_1, sref_model_stochastic_conv2d__channel__pruning_act_quant_FakeQuantWithMinMaxVars_eightbit_2 },
              { sref_model_Reshape_eightbit_0, sref_model_Reshape_eightbit_1, sref_model_Reshape_eightbit_2 });
    ctx.eval();
}
{
    ctx.add(new RamTensor<float>(), sref_model_Reshape_0, 1);
    ctx.push(new DequantizeOp(), 
             { sref_model_Reshape_eightbit_0, sref_model_Reshape_eightbit_1, sref_model_Reshape_eightbit_2 },
             { sref_model_Reshape_0 });
    ctx.eval();
}
{    
...
}
{
    ...
    ctx.push(new GatherOp<float>(),
             { sref_model_Reshape_0, sref_model_GatherV2_indices_0, sref_model_GatherV2_axis_0 }, 
...
{
    ctx.add(new RamTensor<int>(), sref_model_stochastic_dense__channel__pruning_add_eightbit_0, 2);
    ctx.add(new RamTensor<float>({1}), sref_model_stochastic_dense__channel__pruning_add_eightbit_1, 2);
    ctx.add(new RamTensor<float>({1}), sref_model_stochastic_dense__channel__pruning_add_eightbit_2, 2);
    ctx.push(new QuantizedAddOp<uint8_t, uint8_t, int>(), 
...
{
    ctx.add(new RamTensor<float>({1}), sref_model_stochastic_dense__channel__pruning_add_eightbit_requant_range_0, 1);
    ctx.add(new RamTensor<float>({1}), sref_model_stochastic_dense__channel__pruning_add_eightbit_requant_range_1, 1);
    ctx.push(new Requantization_RangeOp(),
             { sref_model_stochastic_dense__channel__pruning_add_eightbit_0, sref_model_stochastic_dense__channel__pruning_add_eightbit_1, sref_model_stochastic_dense__channel__pruning_add_eightbit_2 },
             { sref_model_stochastic_dense__channel__pruning_add_eightbit_requant_range_0, sref_model_stochastic_dense__channel__pruning_add_eightbit_requant_range_1 });
    ctx.eval();
}
{   
    ctx.add(new RamTensor<uint8_t>(), sref_model_stochastic_dense__channel__pruning_add_eightbit_requantize_0, 1);
    ctx.add(new RamTensor<float>({1}), sref_model_stochastic_dense__channel__pruning_add_eightbit_requantize_1, 1);
    ctx.add(new RamTensor<float>({1}), sref_model_stochastic_dense__channel__pruning_add_eightbit_requantize_2, 1);
    ctx.push(new RequantizeOp(),
             { sref_model_stochastic_dense__channel__pruning_add_eightbit_0, sref_model_stochastic_dense__channel__pruning_add_eightbit_1, sref_model_stochastic_dense__channel__pruning_add_eightbit_2, sref_model_stochastic_dense__channel__pruning_add_eightbit_requant_range_0, sref_model_stochastic_dense__channel__pruning_add_eightbit_requant_range_1 },
             { sref_model_stochastic_dense__channel__pruning_add_eightbit_requantize_0, sref_model_stochastic_dense__channel__pruning_add_eightbit_requantize_1, sref_model_stochastic_dense__channel__pruning_add_eightbit_requantize_2 });
    ctx.eval();
}
{
    ctx.add(new RamTensor<float>(), sref_model_stochastic_dense__channel__pruning_add_0);
    ctx.push(new DequantizeOp(), 
             { sref_model_stochastic_dense__channel__pruning_add_eightbit_requantize_0, sref_model_stochastic_dense__channel__pruning_add_eightbit_requantize_1, sref_model_stochastic_dense__channel__pruning_add_eightbit_requantize_2 },
             { sref_model_stochastic_dense__channel__pruning_add_0 });
}
}
